...
# Commands
<!-- commands -->
* [`minecraft-server-cli hello PERSON`](#minecraft-server-cli-hello-person)
* [`minecraft-server-cli hello world`](#minecraft-server-cli-hello-world)
...
* [`minecraft-server-cli plugins update`](#minecraft-server-cli-plugins-update)

## `minecraft-server-cli hello PERSON`

Say hello

```
USAGE
  $ minecraft-server-cli hello PERSON -f <value>
...
_See code: [dist/commands/hello/index.ts](https://github.com/TheAce0296/minecraft-server-cli/blob/v0.0.0/dist/commands/hello/index.ts)_

## `minecraft-server-cli hello world`
